...
include $_SERVER['DOCUMENT_ROOT'].'/api/table_component.php';

include $_SERVER['DOCUMENT_ROOT'].'/api/description_component.php';
...
<tbody>
<tr>
<th style="background:#f00;color:#fff;padding:12px 10px;text-align:center;vertical-align:top;font-size:110%;font-weight:500"><h4 style="padding:0;margin:0"><a href="/" class="image-mini-icon icon-closemenu"></a> <?php echo $check_1blogger.$check_2blogger.$titlecontent3;
...
<?php
include $_SERVER['DOCUMENT_ROOT'].'/api/label_component.php';
?>
