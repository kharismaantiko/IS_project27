...
<tbody>
<tr>
<th style="background:#000000"><h4 style="padding:0;margin:0"><a href="indukseluler.php" class="image-mini-icon icon-closemenu"></a> <?php echo $titlecontentCS; ?></h4></th>
</tr>
<tr>
<td>
<div class="HPGallery">
...
if($prevpageCS == '#'){
?>
<button style="display:inline-block;margin:20px 15px;width:35%;float:right" onclick="location.href='indukseluler.php?uri=<?php echo base64_encode($nextpageCS); ?>'">Next</button>
<?php
}else if($nextpageCS == '#'){
?>
<button style="display:inline-block;margin:20px 15px;width:35%;float:left" onclick="location.href='indukseluler.php?&uri=<?php echo base64_encode($prevpageCS); ?>'">Prev</button>
<?php
}else{
?>
<button style="display:inline-block;margin:20px 15px;width:35%;float:left" onclick="location.href='indukseluler.php?uri=<?php echo base64_encode($prevpageCS); ?>'">Prev</button>
